    ...
    if not status:
        ...
        if project == "pulsar":
            if not skip_docker:
                ...
                run_bash(["python3.9", "./e2e-tests-framework/runner.py", "run", "-f", "./e2e-tests-framework/docker/tests/simple.yaml"], cwd=os.path.join(working_dir, "pulsar-validation-tool"))
