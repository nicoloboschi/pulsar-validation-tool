...
#docker cp /Users/nicolo.boschi/dev/luna283/pulsar-functions/runtime-all/target/java-instance.jar pulsar:/pulsar/instances/java-instance.jar
docker cp /Users/nicolo.boschi/dev/snowflake-connector/pulsar-snowflake-connector/target/pulsar-snowflake-connector-0.1.10-SNAPSHOT.nar pulsar:/pulsar/connectors/pulsar-snowflake-connector-0.1.11-beta.nar
